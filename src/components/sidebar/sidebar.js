        ...
        return (
            <>    
                ...
                <nav className="sidebar__menu">
                    ...
                    <div className="sidebar__menu-about">
                        <Link to="/about">
                            ABOUT
                        </Link> 
                    </div>
                ...
                <div className="left-icons-twitter">
                    <a href="https://twitter.com" target="_blank">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            15.7143 2.75362 14.1964 2.24638 12.2321C2.46377 12.3214 2.75362 12.3214 3.04348 12.3214C3.4058 12.3214 
                            3.76812 12.2321 4.13043 12.1429C2.24638 11.6071 0.797101 9.55357 0.797101 7.14286V7.05357C1.37681 7.41071
                            1.95652 7.67857 2.68116 7.67857C2.1203 7.21924 1.66104 6.59515 1.34478 5.86256C1.02852 5.12997 0.865208
                            4.31191 0.869565 3.48214C0.869565 2.58929 1.08696 1.69643 1.44928 0.982143C3.47826 4.01786 6.52174 
                            6.07143 9.92754 6.25C9.85507 5.89286 9.85507 5.53571 9.85507 5.08929C9.85507 2.32143 11.6667 0 13.9855 
                            0C15.1449 0 16.2319 0.625 16.9565 1.60714C17.8986 1.33929 18.7681 0.982143 19.5652 0.357143C19.2754 
                            1.51786 18.6232 2.5 17.7536 3.125C18.4783 3.03571 19.2754 2.76786 20 2.41071C19.4203 3.39286 18.7681 
                            4.28571 17.971 5Z" fill="#868686"/>
                        </svg>
                    </a>
                </div>
            </>
